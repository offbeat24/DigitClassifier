...
public class Classifier {
    ...
    private ByteBuffer convertBitmapToGrayByteBuffer(Bitmap bitmap) {
        ByteBuffer byteByBuffer = ByteBuffer.allocateDirect(bitmap.getByteCount());
        byteByBuffer.order(ByteOrder.nativeOrder());
        ...
        for (int pixel : pixels) {
            ...
            byteByBuffer.putFloat(normalizedPixelValue);
        }
